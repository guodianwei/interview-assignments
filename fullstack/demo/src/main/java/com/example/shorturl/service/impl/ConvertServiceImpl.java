...
public class ConvertServiceImpl implements ConvertService {
    ...
    private RLongAdder shortCodeAdder ;
    ...
    public void init() {
        ...
        if(!CollectionUtils.isEmpty(all)){
            all.forEach(entity->{
                bloomFilter.add(entity.getShortCode());
            });
        }
        ...
        shortCodeAdder = redissonClient.getLongAdder("short_code_number_sender");
    }
    ...
    public ConvertVO getShortCodeByFullUrl(String fullUrl) {
        ...
        addConvertEntity.setShortCode(CommonConstant.PRIFIX_SHORT_URL + shortUrlSuffix);
        //
    ...
    private MapLoader<String, ConvertVO> createMapLoader() {
        MapLoader<String, ConvertVO> mapLoader = new MapLoader<String, ConvertVO>() {
            ...
            public ConvertVO load(String shortCode) {
                ConvertEntity shotCode = convertDao.findByShortCode(shortCode);
            ...
            public Iterable<String> loadAllKeys() {
                ...
                convertEntities.forEach(convertEntity -> {
                    shortCodeList.add(convertEntity.getShortCode());
                });
